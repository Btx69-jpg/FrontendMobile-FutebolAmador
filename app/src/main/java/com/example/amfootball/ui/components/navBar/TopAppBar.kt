...
fun MainTopAppBar(
    ...
    TopAppBar(
        ...
        actions = {
            IconButton(
                onClick = { navController.navigate(Routes.GeralRoutes.SETTINGS.route) },
            ...
            if (!isLoggedIn) {
                IconButton(
                    onClick = { navController.navigate(Routes.UserRoutes.LOGIN.route) },
                ...
                IconButton(
                    onClick = { navController.navigate(Routes.UserRoutes.SIGNUP.route) },
