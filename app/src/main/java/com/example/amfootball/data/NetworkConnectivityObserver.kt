 ...
 *
 * Esta classe atua como uma abstração sobre o [android.net.ConnectivityManager] do sistema Android,
 * convertendo os callbacks de sistema baseados em eventos num fluxo contínuo de dados ([kotlinx.coroutines.flow.Flow])
 ...
 *
 * @property context O contexto da aplicação injetado via Hilt ([dagger.hilt.android.qualifiers.ApplicationContext]),
...
class NetworkConnectivityObserver @Inject constructor(
     ...
     *
     * Utiliza um [kotlinx.coroutines.flow.callbackFlow] para converter os eventos do [ConnectivityManager.NetworkCallback]
     ...
     *
     * @return Um [kotlinx.coroutines.flow.Flow] que emite `true` se houver acesso validado à internet, e `false` caso contrário.
     */
